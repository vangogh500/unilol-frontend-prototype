...
export default class ErrorBanner extends React.Component {
  ...
  render() {
    ...
    return (
      <div className={"card red darken-1 " + hideElement(!this.state.active)} role="alert">
        <div className="card-content white-text">
          UniLol was unable to complete a recent request: {this.state.error}<br />
